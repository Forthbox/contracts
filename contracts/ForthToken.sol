...
contract ForthToken is IERC20 {
    using SafeMath for uint256;

    string private _name = "Ampleforth Governance";
    string private _symbol = "FORTH";

    uint8 private _decimals = 18;
    uint256 private constant _totalSupply = 15000000 * 10**18;
